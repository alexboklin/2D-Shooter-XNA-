...
namespace GameProject
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            burger = new Burger(Content, "burger", GameConstants.WINDOW_WIDTH / 2,
                GameConstants.WINDOW_HEIGHT * 7 / 8, burgerShot);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            for (int i = 0; i < bears.Count; i++)
            {
                for (int j = i + 1; j < bears.Count; j++)
                {
                    ...
                    {
                        CollisionResolutionInfo collisionResolutionInfo = CollisionUtils.CheckCollision(
        ...
        private void SpawnBear()
        {
            ...
            int bearX = GetRandomLocation(GameConstants.SPAWN_BORDER_SIZE,
                graphics.PreferredBackBufferWidth - 2 * GameConstants.SPAWN_BORDER_SIZE);
            int bearY = GetRandomLocation(GameConstants.SPAWN_BORDER_SIZE,
            ...
            // create new bear
            TeddyBear newBear = new TeddyBear(Content, "teddybear", bearX, bearY, 
                velocity, teddyBounce, teddyShot);
